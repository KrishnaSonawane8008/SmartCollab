...
## Postgres
-install postgres installer from <S>https://www.enterprisedb.com/downloads/postgres-postgresql-downloads</a>
...
-once installed postgres starts its server in the background, it starts on its own you dont have to manually start it
-once the installation setup is done access postgres with